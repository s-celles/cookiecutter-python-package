...
class TestPerformance:
    ...
    @pytest.mark.slow
    def test_generation_speed(self, template_dir: Path, minimal_context: Dict[str, Any]) -> None:
...
class TestStress:
    ...
    def test_special_project_names(self, template_dir: Path, special_chars: str) -> None:
